window.autoLoot = function(obfuscate, game, variables) {
	...
	*/
	...
	var bind = function(opt) {
		...
		defaultLootBarnUpdateFunction = lootBarn.prototype[obfuscate.update];
		lootBarn.prototype[obfuscate.update] = function(e, t, a) {
	...
	var unbind = function() {
		lootBarn.prototype[obfuscate.update] = defaultLootBarnUpdateFunction;
