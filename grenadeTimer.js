window.grenadeTimer = function(obfuscate, game) {
	...
	var initTimer = function() {
		game.scope[obfuscate.notifications][obfuscate.init](function onElapsed() {
			freeTimer();
	...
	var freeTimer = function() {
		game.scope[obfuscate.notifications] && game.scope[obfuscate.notifications][obfuscate.free](true);
		dead = true;
	}
